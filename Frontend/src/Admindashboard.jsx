      ...
      <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
        <div className="p-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-xl text-gray-900">Career Sync</span>
          </div>
        ...
        <nav className="flex-1 px-4 pb-4">
          <div className="space-y-2">
            <a href="#" className="flex items-center space-x-3 text-blue-600 bg-blue-50 px-3 py-3 rounded-lg font-medium">
              <LayoutDashboard className="w-5 h-5" />
              <span>Dashboard</span>
            </a>
            
            <a href="#" className="flex items-center space-x-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 px-3 py-3 rounded-lg transition-colors">
          ...
          <div className="mt-auto pt-8 border-t border-gray-200">
            ...
            <a href="#" className="flex items-center space-x-3 text-gray-600 hover:text-gray-900 hover:bg-red-50 hover:text-red-600 px-3 py-3 rounded-lg transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-900">Student Applications by Job Category</h3>
                <button className="text-blue-600 text-sm hover:text-blue-700 font-medium">View All</button>
              </div>
                ...
                {applicationData.map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <div className="text-right">
                      <div className="font-semibold text-gray-900">{item.applications}</div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <span className="font-medium text-green-900">Verify Students</span>
              </button>
